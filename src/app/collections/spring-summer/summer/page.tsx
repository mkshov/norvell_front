...
const summer = [
	...
	},
	{
		...
		text_it:
			"Un capolavoro essenziale nel guardaroba di ogni conoscitore di eleganza senza tempo: abito semi-foderato, tre bottoni, due tasche a bugnato e pantaloni con due pieghe. Tagliato e cucito interamente a mano da un tessuto con un esclusivo design Norvell, in lana 100% S’170.",
		text_en:
			"Незаменимый шедевр в гардеробе каждого ценителя вневременной элегантности: полуподкладной костюм, три пуговицы, два кармана с листочкой и брюки с двумя складками. Полностью сшит вручную из ткани с эксклюзивным дизайном Norvell, 100% шерсть S’170.",
	},
	{
